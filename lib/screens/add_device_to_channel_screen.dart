...
class _AddDeviceToChannelScreenState extends State<AddDeviceToChannelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String? preselectedChannel = args is String ? args : null;
        ...
        return Scaffold(
          ...
          bottomNavigationBar: SafeArea(
            child: Padding(
              ...
              child: GradientButton(text: 'Add Device', onPressed: _save),
            ),
          ),
          body: SafeArea(
            child: Column(
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'Choose the channel, provide a device name, pick an icon and tap Add Device.',
                          style: TextStyle(color: AppColors.textLight, fontSize: 12, fontStyle: FontStyle.italic, height: 1.4),
                        ),
                        const SizedBox(height: 20),

                        // Device Name + Icon picker
                        Row(
                          children: [
                            Expanded(
                              child: Column(
                        ...
                        const Text('Slide left to remove a device.',
  ...
  Widget _dismissibleDevice(DeviceItem d, int idx, String channelName) {
    return Padding(
      ...
      child: Dismissible(
        key: Key('${channelName}_${d.name}_${d.plug}'),
        ...
        onDismissed: (dir) {
          if (dir == DismissDirection.endToStart) {
            _store.deleteDevice(channelName, d);
          }
        },
        child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Slide left to delete.',
  ...
  void _save() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('"$name" added to ${ch.name}'), backgroundColor: AppColors.green));
  }
